...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "apriora_recordings" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"interview_id" integer NOT NULL,
	"s3_file_name" text NOT NULL
);
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "apriora_recordings" ADD CONSTRAINT "apriora_recordings_interview_id_apriora_interviews_id_fk" FOREIGN KEY ("interview_id") REFERENCES "public"."apriora_interviews"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "audios_id_idx" ON "apriora_audios" USING btree ("id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "recordings_id_idx" ON "apriora_recordings" USING btree ("id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "apriora_session" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "videos_id_idx" ON "apriora_videos" USING btree ("id");